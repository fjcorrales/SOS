...
public class User implements org.apache.axis2.databinding.ADBBean {
	 ...
	 * Namespace URI = http://model.sos.fi.upm.es/xsd Namespace Prefix = ns1
	 */
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localNameTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://model.sos.fi.upm.es/xsd", "name"));
		...
		if (localPwdTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://model.sos.fi.upm.es/xsd", "pwd"));
